...
function getDefaultSEO(path: string): Metadata {
  const defaults: Record<string, Metadata> = {
    ...
    "/blog": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/blog" }, // Corrected for defaults
    },
    "/contact": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/contact" }, // Corrected for defaults
    },
    "/projects": {
    ...
    "/browser-tabs": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/browser-tabs" }, // Corrected for defaults
    },
    "/conferences": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/conferences" }, // Corrected for defaults
    },
    "/link-page": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/link-page" }, // Corrected for defaults
    },
    "/logo-page": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/logo-page" }, // Corrected for defaults
    },
    "/site-history": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/site-history" }, // Corrected for defaults
    },
    "/site-map": {
      ...
      alternates: { canonical: "https://www.chrislanejones.com/site-map" }, // Corrected for defaults
    },
    "/wordpress-maintenance": {
      ...
      alternates: {
        canonical: "https://www.chrislanejones.com/wordpress-maintenance",
